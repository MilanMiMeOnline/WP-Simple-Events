...
abstract class AbstractEventFieldWidget extends Widget_Base {
	...
	final protected function render(): void {
		...
		if ( $this->editor->is_editing() ) {
			echo '<div class="wpse-elementor-placeholder" role="status">'
				. esc_html__( 'This event field has no public value for the selected or current event.', 'mime-simple-events-calendar' )
				. '</div>';
		}
	}
	...
	protected function add_label_controls( string $default_label ): void {
		$this->add_control(
			'show_label',
			array(
				'label'        => esc_html__( 'Show label', 'mime-simple-events-calendar' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'mime-simple-events-calendar' ),
				'label_off'    => esc_html__( 'Hide', 'mime-simple-events-calendar' ),
				'return_value' => 'yes',
				'default'      => 'yes',
			)
		);
		$this->add_control(
			'label',
			array(
				'label'       => esc_html__( 'Label text', 'mime-simple-events-calendar' ),
	...
	private function register_style_controls(): void {
		...
		$this->start_controls_section(
			'wpse_style',
			array(
				'label' => esc_html__( 'Style', 'mime-simple-events-calendar' ),
		...
		$this->add_control(
			'spacing',
			array(
				'label'      => esc_html__( 'Bottom spacing', 'mime-simple-events-calendar' ),
