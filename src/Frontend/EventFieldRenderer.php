...
final class EventFieldRenderer {
	...
	public function date_time(
		...
		$visible_label = '' !== $label ? $label : __( 'Date and time:', 'mime-simple-events-calendar' );
	...
	public function venue(
		...
		$visible_label = '' !== $label ? $label : __( 'Location:', 'mime-simple-events-calendar' );
	...
	public function location_action( EventPresentation $presentation, string $label = '' ): string {
		$visible_label = '' !== $label ? $label : __( 'View location', 'mime-simple-events-calendar' );
	...
	public function categories(
		...
		return $this->terms(
			...
			'' !== $label ? $label : __( 'Categories:', 'mime-simple-events-calendar' ),
			$show_label
		);
	}
	...
	public function tags(
		...
		return $this->terms(
			...
			$presentation->tags,
			'wpse-event-tags',
			'' !== $label ? $label : __( 'Tags:', 'mime-simple-events-calendar' ),
			$show_label
		);
	}
