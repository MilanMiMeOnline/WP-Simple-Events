# QA report — MiMe Simple Events and Calendar 0.2.0

**Date:** 2026-07-20
**Candidate:** MiMe Simple Events and Calendar 0.2.0
**Branch:** `codex/release-0.2.0`
**Archive SHA-256:** `ab7984251afd1d36ca144176e47f9ddac4f7d9c49588ddd4b88b35bd02c8c927`

## Result

MiMe Simple Events and Calendar 0.2.0 is a locally qualified installable release candidate. The plugin header, runtime constant, WordPress stable tag, npm package metadata, lockfile and translation catalogue all identify the release as 0.2.0. The packaged archive was built from the production allowlist, verified and reproduced byte-for-byte.
...
Installable archive: `dist/mime-simple-events-calendar-0.2.0.zip`
Checksum file: `dist/mime-simple-events-calendar-0.2.0.zip.sha256`
