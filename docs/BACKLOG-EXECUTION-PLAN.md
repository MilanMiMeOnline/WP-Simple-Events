...
2. Register dedicated MiMe Simple Events and Calendar widgets for the WP4 field set, using shared abstract behaviour only where responsibilities remain clear.
