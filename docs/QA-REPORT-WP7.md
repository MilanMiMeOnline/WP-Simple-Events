...
**Date:** 2026-07-20
**Candidate:** MiMe Simple Events and Calendar 0.1.1
...
WP7 accepts MiMe Simple Events and Calendar 0.1.1 as a locally qualified installable candidate. The exact staged package, not only the source tree, passed the supported WordPress matrix, browser regression suite and deterministic release checks. All eight findings in `docs/BACKLOG-TESTING.md` now have implementation and release-qualification evidence.
...
1. The configured `wordpress/plugin-check-action@v1` job must be observed green against `.release/mime-simple-events-calendar` for the WP7 release commit before public publication.
...
Installable archive: `dist/mime-simple-events-calendar-0.1.1.zip`
Checksum file: `dist/mime-simple-events-calendar-0.1.1.zip.sha256`
