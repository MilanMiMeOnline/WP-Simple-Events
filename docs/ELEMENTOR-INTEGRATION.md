...
- The Calendar content controls include the shared Auto/Show/Hide category-color legend. Auto avoids duplicating visible category filters; the setting changes presentation only and never changes event/category metadata or the feed query.
